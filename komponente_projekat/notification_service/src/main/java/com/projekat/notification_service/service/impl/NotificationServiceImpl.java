package com.projekat.notification_service.service.impl;
...
import com.projekat.notification_service.mapper.NotificationMapper;
import com.projekat.notification_service.repository.NotificationRepository;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    public void sendActivationEmail(ActivationDto activationDto) throws InterruptedException {
        String content = "Hello " + activationDto.getFirstName() + ",\n\nYour new account has been created. Please click the link below to verify your account. \n\n" +
                "http://localhost:8083/korisnicki_servis/api/user/confirm-account?token=" + activationDto.getToken();
